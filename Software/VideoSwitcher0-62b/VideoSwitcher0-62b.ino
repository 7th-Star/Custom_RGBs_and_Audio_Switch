...
const byte demuxout[] = {B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,B10000000,
B10000000,};

const byte x1[] = {13,16,20,3,33,34,32,25,30,35,42,5,15,38,14};
...
const char console_15[] PROGMEM = "Kaneko Super Nova";
...
const char tvset_15[] PROGMEM = "AUX RGB 14";
...
void displayinput(){
  ...
  u8g2.drawStr(x1[input],38,buffer1);
